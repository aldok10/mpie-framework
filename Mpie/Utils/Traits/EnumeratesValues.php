...
use Mpie\Utils\Proxy\HigherOrderCollectionProxy;
use Symfony\Component\VarDumper\VarDumper;
use Traversable;
use UnexpectedValueException;
use UnitEnum;

use function Mpie\Utils\class_basename;
use function Mpie\Utils\data_get;
use function Mpie\Utils\e;
 ...
 * @property HigherOrderCollectionProxy $mpie
...
trait EnumeratesValues
{
    ...
    /**
     * Get the mpie value of a given key.
     *
     * @param (callable(TValue):mixed)|string|null $callback
     *
     * @return TValue
     */
    public function mpie($callback = null)
    {
        $callback = $this->valueRetriever($callback);
